...
description: UI design specification workflow with AI-generated mockup prompts. Define
  the visual interface through iterative mockup refinement.
...
**Prerequisite**: The product specification at `.specify.specify/memory/product-spec.md` should exist. If it doesn't, recommend running `/speckit.brainstorm` first.

Follow this execution flow:

### Phase 1: Load Product Context

1. Read `.specify.specify/memory/product-spec.md` to understand:
...
1. Save the completed specification to `.specify.specify/memory/ui-spec.md`.
