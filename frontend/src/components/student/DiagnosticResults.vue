  ...
  <div class="max-w-lg mx-auto">
    ...
    >
      ...
      <h2 class="text-2xl font-black mb-2">
        {{ groupLabels[recommendedGroup]?.label || recommendedGroup }}
      </h2>
      <p class="text-on-primary/80">
        {{ groupLabels[recommendedGroup]?.desc || '' }}
      </p>
    </div>
    ...
    <div class="bg-surface-container rounded-2xl p-5 mb-6">
      ...
      <p class="text-xs text-on-surface-variant mt-2 text-end">
    ...
    <div
      ...
      class="bg-surface-container rounded-2xl p-5"
    >
      ...
      <div
        ...
        class="flex justify-between items-center py-2 border-b border-outline-variant/30 last:border-0"
      >
