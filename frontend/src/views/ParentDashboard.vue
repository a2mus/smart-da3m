...
<template>
  <div class="bg-background text-on-surface mb-24 min-h-screen" dir="rtl">
      ...
      <section>
        <div class="bg-primary p-6 rounded-[2.5rem] text-white relative overflow-hidden group">
          ...
          <div class="relative z-10 flex flex-col gap-4">
            ...
            <button class="bg-secondary text-white px-6 py-3 rounded-2xl font-bold self-start mt-2 shadow-lg shadow-secondary/20 active:scale-95 transition-transform" @click="router.push('/student/journey')">
                ابدأ رحلة التلميذ
            </button>
          </div>
        </div>
    ...
    <!-- BottomNavBar -->
    <nav class="fixed bottom-0 left-0 w-full flex flex-row-reverse justify-around items-center px-4 pb-6 pt-3 bg-[#faf9f6]/80 dark:bg-stone-900/80 backdrop-blur-xl z-50 rounded-t-3xl shadow-[0_-4px_40px_rgba(0,109,119,0.06)] max-w-lg mx-auto right-0">
